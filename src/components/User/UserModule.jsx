    ...
    <div className="layout-wrapper">
      ...
      <main className="layout-main">
        <header className="dashboard-header fade-in">
          ...
          <div className="flex-row align-center glass-card" style={{ padding: '0.5rem 1rem', width: 'auto', borderRadius: '50px', gap: '1rem' }}>
            ...
            <button className="btn btn-secondary flex-row align-center" onClick={handleLogout} style={{ padding: '0.4rem 0.8rem', fontSize: '0.9rem', borderRadius: '20px', gap: '0.3rem' }}>
